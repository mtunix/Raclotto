...
import { Card, Row, Col, Typography, Button, Statistic, Progress, Divider, Rate, List, Space, Tag, Switch } from 'antd';
import { TrophyOutlined, FireOutlined, StarOutlined, CompressOutlined, ExpandOutlined } from '@ant-design/icons';
    ...
    return (
        ...
        >
            <div className="dashboard-ingredient-item-content">
                <span className="dashboard-ingredient-name">{props.ingredient.name}</span>
...
function IngredientListGroupItemCount(props: IngredientListGroupItemCountProps) {
    ...
    return (
        ...
        >
            <div className="dashboard-ingredient-item-content">
                <span className="dashboard-ingredient-name">{props.ingredient.name}</span>
                <span className="dashboard-ingredient-count">{props.ingredient.pan_count}</span>
            </div>
        </List.Item>
    );
}
...
function PanListItem(props: PanListItemProps) {
    ...
    return (
        <List.Item
            className="dashboard-pan-item"
        >
            <div style={{width: '100%'}}>
                <div className="dashboard-pan-header">
                    <div style={{flex: 1}}>
                        <div className="dashboard-pan-title">
                            {props.pan.name}
                        </div>
