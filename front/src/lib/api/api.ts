...
type DeserializeFunction = (data: unknown) => { data: unknown; jsonapi?: Record<string, unknown>; links?: Record<string, unknown>; meta?: Record<string, unknown> };

// eslint-disable-next-line @typescript-eslint/no-var-requires
const deserialize = require("deserialize-json-api/src").deserialize as DeserializeFunction;
...
export const onErrorRetry = (error: ApiError, key: string, config: unknown, revalidate: (options: { retryCount: number }) => void, { retryCount }: { retryCount: number }) => {
