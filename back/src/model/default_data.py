...
LEVELS = [
    ...
    Level(name="level.kaeseKnauserer", required_experience=100),
    Level(name="level.kartoffelPionier", required_experience=250),
    Level(name="level.beilagenBaendiger", required_experience=450),
    Level(name="level.knoblauchKrieger", required_experience=700),
    Level(name="level.saucenSucher", required_experience=1000),
    Level(name="level.jalapenoJaeger", required_experience=1350),
    Level(name="level.ananasApostel", required_experience=1750),
    Level(name="level.zwiebelZelebrator", required_experience=2200),
    Level(name="level.pfannenArchitekt", required_experience=2700),
    Level(name="level.drehDoktor", required_experience=3300),
    Level(name="level.zufallsZaehmer", required_experience=4000),
    Level(name="level.stapelSpezialist", required_experience=4800),
    Level(name="level.vierSchichtVirtuose", required_experience=5700),
    Level(name="level.jackpotJaeger", required_experience=6700),
    Level(name="level.gaumenGrossherzog", required_experience=7800),
    Level(name="level.brutzlerBoss", required_experience=9000),
    Level(name="level.kaeseKaiser", required_experience=10300),
    Level(name="level.gourmetGouverneur", required_experience=11700),
    Level(name="level.raclottoRegent", required_experience=13200),
]
